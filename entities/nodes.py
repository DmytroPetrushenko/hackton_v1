...
def create_ai_processor_node(state: PhishingState, agent, name: str):
    """
    Node for interacting with AI to analyze email content.

    Args:
        state (PhishingState): Shared state object;
        agent (object): AI agent for email analysis;
        name (str): Node name or identifier;
    ...
    try:
        ...
        for message_id in message_ids:
            try:
                ...
                if isinstance(ai_result, AIMessage) and re.search(r'Phishing', ai_result.content):
